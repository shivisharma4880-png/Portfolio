          ...
          <div className="flex flex-col items-end gap-2">
            ...
            {project.githubUrl ? (
              <a
                ...
                className="group text-[#D7E2EA]/60 hover:text-[#D7E2EA] transition-all duration-300 mt-1 flex items-center gap-1.5 px-2 py-1.5 rounded-full hover:bg-[#D7E2EA]/10 mr-2"
                title="GitHub"
              >
                <svg
                ...
                <span className="text-xs uppercase tracking-widest max-w-0 overflow-hidden group-hover:max-w-[100px] opacity-0 group-hover:opacity-100 transition-all duration-300 ease-out font-medium">
                  GitHub
                </span>
              </a>
            ) : null}
