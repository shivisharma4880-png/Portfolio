...
export default function SmartApplyCaseStudyPage() {
  ...
  return (
    <div className="relative" style={{ background: '#0C0C0C', overflowX: 'clip' }}>
      ...
      <CaseStudySection id="walkthrough" title="Video Walkthrough" variant="light" className="-mt-6">
        <FadeIn delay={0.1} y={20}>
          <div className="rounded-[40px] sm:rounded-[50px] border-2 border-[#0C0C0C]/15 bg-[#0C0C0C] p-4 sm:p-6 md:p-8 shadow-2xl">
            <div
              className="relative w-full overflow-hidden rounded-2xl sm:rounded-3xl border border-[#D7E2EA]/20"
              style={{ paddingBottom: '56.25%' /* 16:9 */ }}
            >
              <iframe
                src="https://drive.google.com/file/d/1tbZGx-43cwpja2Bk1kZjOnkPSVVPqRqd/preview"
                className="absolute inset-0 w-full h-full"
                allow="autoplay; encrypted-media"
                allowFullScreen
                title="Smart Apply Video Walkthrough"
                style={{ border: 'none' }}
              />
            </div>
          </div>
      ...
      <CaseStudySection id="overview" title="Overview" variant="dark" className="-mt-6">
        <FadeIn delay={0.05} y={20}>
          <div className="w-full flex items-center justify-center bg-white overflow-hidden rounded-[30px] sm:rounded-[40px] md:rounded-[50px] border border-[#D7E2EA]/20 p-2 mb-10 shadow-xl">
            <img
              src="/smart_apply_ai_poster.png"
              alt="Smart Apply AI Promotional Poster"
              loading="lazy"
      ...
      <CaseStudySection id="ai-design" title="AI Product Design" variant="dark">
        <div className="grid gap-6 sm:grid-cols-2">
          {AI_DESIGN.map((item, i) => (
      ...
      <CaseStudySection id="trust-safety" title="Trust & Safety" variant="light">
        <ul className="flex flex-col gap-5">
          {TRUST_SAFETY.map((item, i) => (
