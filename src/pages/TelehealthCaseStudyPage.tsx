...
export default function TelehealthCaseStudyPage() {
  ...
  return (
    <div className="relative" style={{ background: '#0C0C0C', overflowX: 'clip' }}>
      ...
      <CaseStudySection id="screens" title="In the Product" variant="light">
      ...
      <CaseStudySection id="compliance" title="Compliance & Trust" variant="light">
